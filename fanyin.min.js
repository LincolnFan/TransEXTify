...
function(e, t) {
    ...
    function o() {}
    var a, s, l = document, c = l.head || l.getElementsByTagName("head")[0] || l.documentElement, u = c.getElementsByTagName("base")[0], d = /\.css(?:\?|$)/i, f = /loaded|complete|undefined/;
...
function(e, t, n) {
    ...
    r._modify = function(t, n) {
        var r = i(t)
          , o = d[r];
        return o && o.status === h.COMPILED ? a(n, o) : (f[r] || (f[r] = []),
        f[r].push(n)),
        e
    }
    ,
...
define("newweb/common/ZeroClipboard", [], function(e, t) {
    !function(e, t) {
        "use strict";
        var n, r, i, o = e, a = o.document, s = o.navigator, l = o.setTimeout, c = o.clearTimeout, u = o.setInterval, d = o.clearInterval, f = o.getComputedStyle, p = o.encodeURIComponent, h = o.ActiveXObject, m = o.Error, g = o.Number.parseInt || o.parseInt, v = o.Number.parseFloat || o.parseFloat, y = o.Number.isNaN || o.isNaN, b = o.Date.now, x = o.Object.keys, w = o.Object.prototype.hasOwnProperty, T = o.Array.prototype.slice, _ = function() {
            var e = function(e) {
                return e
            };
            ...
            var e, t, n, r, i, o = k(arguments), a = o[0] || {};
            for (e = 1,
            t = o.length; e < t; e++)
                if (null != (n = o[e]))
                    for (r in n)
        ...
        }, q = null == o.opener && (!!o.top && o != o.top || !!o.parent && o != o.parent), I = "html" === a.documentElement.nodeName, H = {
            bridge: null,
            version: "0.0.0",
            pluginType: "unknown",
            sandboxed: null,
            ...
            var t = null;
            return (!1 === q || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1),
            t
        }, Te = function(e) {
            ...
            case "aftercopy":
                _e(e),
                Ke.clearData(),
                t && t !== qe() && t.focus && t.focus();
                break;
            case "_mouseover":
                Ke.focus(t),
                !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && ke(C({}, e, {
                    type: "mouseenter",
                    bubbles: !1,
                    cancelable: !1
                })),
            ...
            var n, r, i, o = H.sandboxed, a = null;
            if (t = !0 === t,
            !1 === q)
                a = !1;
            else {
            ...
            H.version = u || "0.0.0",
            H.pluginType = c ? "pepper" : l ? "activex" : a ? "netscape" : "unknown"
        };
        Ze(h),
        Ye(!0);
        var Ke = function() {
...
define("newweb/common/account", ["./log"], function(e, t) {
    ...
    "http:" === window.location.protocol && (b.isHttps = 0,
    b.PROTOCOL = "http",
    b.REGPROTOCOL = "http"),
    t.init = function() {
        ...
        a(".login-out").length > 0) {
            ...
            t += window.encodeURIComponent(window.location.href),
            "https:" === e && (t += "&samesite=true"),
            a(".login-out").attr("href", t)
        }
    }
    ,
...
define("newweb/common/advertisement", ["./utils"], function(e, t) {
    ...
    r(function() {
        ...
        function(e, t, n, i) {
            ...
            r(".inside__products").append(o)
        }("fanyi-advertising-space", o, "100%", 206);
        var a = document.getElementById("fanyi-advertising-space");
        window.addEventListener("message", function(e) {
            if (e.data) {
                var t;
                (t = "string" == typeof e.data ? JSON.parse(e.data) : e.data).height && (a.height = t.height),
                t.width && (a.width = t.width)
            }
        }, !1),
        t(),
        i.addEvent("resize", window, i.throttle(100, t))
    })
}),
function(e) {
...
define("newweb/common/docTrans", ["./form", "./md5", "./jquery-1.7", "./account", "./log", "../langSelect", "./TranslateState", "./star", "./select", "./utils"], function(e, t) {
    ...
    if (p("#docUploadForm").attr("action", window.location.protocol + "//doctrans-service.youdao.com/trandoc/doc/upload"),
    -1 != location.href.indexOf("type=013")) {
        ...
        e.fn.ajaxSubmit = function(t, n, i, s) {
            ...
            function c(n) {
                ...
                function o() {
                    ...
                    o !== d.url && _.setAttribute("action", d.url),
                ...
                function s(t) {
                    if (!y.aborted && !L) {
                        ...
                        if (O && O.location.href !== d.iframeSrc || w) {
                            ...
                            "success" === o ? (d.success && d.success.call(d.context, D, "success", y),
                            k.resolve(y.responseText, "success", y),
                            f && e.event.trigger("ajaxSuccess", [y, d])) : o && (void 0 === n && (n = y.statusText),
                            d.error && d.error.call(d.context, y, o, n),
                            k.reject(y, "error", n),
    ...
    return function(e, t) {
        ...
        function v(e, t) {
            t.src ? R.ajax({
                ...
                async: !1,
                dataType: "script"
            }) : R.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ce, "/*$0*/")),
            t.parentNode && t.parentNode.removeChild(t)
        }
        function y(e, t, n) {
        ...
        function x(e, n, r, i, o, a) {
            o = o || n.dataTypes[0],
            (a = a || {})[o] = !0;
            for (var s, l = e[o], c = 0, u = l ? l.length : 0, d = e === it; c < u && (d || !s); c++)
                "string" == typeof (s = l[c](n, r, i)) && (!d || a[s] ? s = t : (n.dataTypes.unshift(s),
                s = x(e, n, r, i, s, a)));
            return !d && s || a["*"] || (s = x(e, n, r, i, "*", a)),
            s
        }
        function w(e, n) {
        ...
        function k(e, n) {
            ...
            var r, i, o, a, s, l, c, u, d = e.dataTypes, f = {}, p = d.length, h = d[0];
            for (r = 1; r < p; r++) {
                if (1 === r)
        ...
        var O = e.document
          ...
          , R = function() {
            ...
            s.extend = s.fn.extend = function() {
                var e, n, r, i, o, a, l = arguments[0] || {}, c = 1, u = arguments.length, d = !1;
                ...
                --c); c < u; c++)
                    if (null != (e = arguments[c]))
                        for (n in e)
                            r = l[n],
                            l !== (i = e[n]) && (d && i && (s.isPlainObject(i) || (o = s.isArray(i))) ? (o ? (o = !1,
                            a = r && s.isArray(r) ? r : []) : a = r && s.isPlainObject(r) ? r : {},
                            l[n] = s.extend(d, a, i)) : i !== t && (l[n] = i));
                return l
            }
            ,
            s.extend({
        ...
        R.Callbacks = function(e) {
            ...
            var r, i, o, a, s, l = [], c = [], u = function(t) {
                ...
                r = t.length; n < r; n++)
                    i = t[n],
                    "array" === (o = R.type(i)) ? u(i) : "function" === o && (e.unique && f.has(i) || l.push(i))
            }, d = function(t, n) {
                for (n = n || [],
                r = !e.memory || [t, n],
                i = !0,
                ...
                if (r > 1) {
                    for (; n < r; n++)
                        t[n] && t[n].promise && R.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
                            return function(n) {
                                t[e] = arguments.length > 1 ? q.call(arguments, 0) : n,
                                --o || a.resolveWith(a, t)
                            }
                        }(n), a.reject, function(e) {
                            return function(t) {
                                i[e] = arguments.length > 1 ? q.call(arguments, 0) : t,
                                a.notifyWith(s, i)
                            }
                        }(n)) : --o;
                    o || a.resolveWith(a, t)
        ...
        R.support = function() {
            var e, t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g = O.createElement("div"), v = O.documentElement;
            ...
            a.reliableHiddenOffsets = m && 0 === f[0].offsetHeight,
            g.innerHTML = "",
        ...
        R.extend({
            ...
            data: function(e, n, r, i) {
                if (R.acceptData(e)) {
                    R.expando;
                    var o, a, s, l = "string" == typeof n, c = e.nodeType, u = c ? R.cache : e, d = c ? e[R.expando] : e[R.expando] && R.expando, f = "events" === n;
                    if (d && u[d] && (f || i || u[d].data) || !l || r !== t)
                        return d || (c ? e[R.expando] = d = ++R.uuid : d = R.expando),
                        u[d] || (u[d] = {},
                        c || (u[d].toJSON = R.noop)),
                        "object" != typeof n && "function" != typeof n || (i ? u[d] = R.extend(u[d], n) : u[d].data = R.extend(u[d].data, n)),
                        o = a = u[d],
                        i || (a.data || (a.data = {}),
                        a = a.data),
                        r !== t && (a[R.camelCase(n)] = r),
                        f && !a[n] ? o.events : (l ? null == (s = a[n]) && (s = a[R.camelCase(n)]) : s = a,
                        s)
                }
            },
        ...
        R.fn.extend({
            ...
            promise: function(e, n) {
                ...
                e = t),
                e = e || "fx";
                for (var i, o = R.Deferred(), a = this, s = a.length, l = 1, c = e + "defer", u = e + "queue", d = e + "mark"; s--; )
                    (i = R.data(a[s], c, t, !0) || (R.data(a[s], u, t, !0) || R.data(a[s], d, t, !0)) && R.data(a[s], c, R.Callbacks("once memory"), !0)) && (l++,
                    i.add(r));
                return r(),
                o.promise()
            }
        });
        var z, P, B, U = /[\n\t\r]/g, W = /\s+/, $ = /\r/g, X = /^(?:button|input)$/i, V = /^(?:button|input|object|select|textarea)$/i, Y = /^a(?:rea)?$/i, Z = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, K = R.support.getSetAttribute;
        R.fn.extend({
            attr: function(e, t) {
            ...
            toggleClass: function(e, t) {
                ...
                return R.isFunction(e) ? this.each(function(n) {
                    ...
                    if ("string" === n)
                        for (var i, o = 0, a = R(this), s = t, l = e.split(W); i = l[o++]; )
        ...
        R.extend({
            ...
            removeAttr: function(e, t) {
                var n, r, i, o, a = 0;
                if (1 === e.nodeType)
                    for (o = (r = (t || "").split(W)).length; a < o; a++)
                        i = r[a].toLowerCase(),
                        n = R.propFix[i] || i,
                        R.attr(e, i, ""),
        ...
        R.attrHooks.tabindex.set = z.set,
        ...
        R.event = {
                ...
                if (m && (u = m.events)) {
                    ...
                    i = 0; i < t.length; i++) {
                        ...
                        n || s || r || d.remove)
                            ...
                            p.length = 0;
                        0 === p.length && l !== p.length && (d.teardown && !1 !== d.teardown.call(e, s) || R.removeEvent(e, a, m.handle),
                        delete u[a])
                    }
                    R.isEmptyObject(u) && ((f = m.handle) && (f.elem = null),
                ...
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    ...
                    i && !R.event.customEvent[g] || R.event.global[g])
                        ...
                        i) {
                            ...
                            !(f = R.event.special[g] || {}).trigger || !1 !== f.trigger.apply(i, r)) {
                                if (h = [[i, f.bindType || g]],
                                ...
                                (p = d && c[d]) && R.acceptData(c) && p.apply(c, r),
                                !n.isPropagationStopped()); l++)
                                    ;
                                return n.type = g,
                                n.isDefaultPrevented() || f._default && !1 !== f._default.apply(i.ownerDocument, r) || "click" === g && R.nodeName(i, "a") || !R.acceptData(i) || d && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !R.isWindow(i) && ((u = i[d]) && (i[d] = null),
                                R.event.triggered = g,
                                i[g](),
                                R.event.triggered = t,
                                u && (i[d] = u)),
            ...
            dispatch: function(n) {
                ...
                var r, i, o, a, s, l, c, u, d, f, p = (R._data(this, "events") || {})[n.type] || [], h = p.delegateCount, m = [].slice.call(arguments, 0), g = !n.exclusive && !n.namespace, v = (R.event.special[n.type] || {}).handle, y = [];
                if (m[0] = n,
                ...
                h && !n.target.disabled && (!n.button || "click" !== n.type))
                    for (o = n.target; o != this; o = o.parentNode || this) {
                        ...
                        r = 0; r < h; r++)
                            ...
                            u.isPositional ? f = (f || (s[d] = R(d))).index(o) >= 0 : f === t && (f = s[d] = u.quick ? ie(o, u.quick) : R(o).is(d)),
                            f && c.push(u);
                        c.length && y.push({
                            elem: o,
                            matches: c
            ...
            var p = f.getText = function(e) {
              ...
              , h = f.selectors = {
                ...
                relative: {
                    ...
                    "": function(t, r, i) {
                        var a, s = o++, l = n;
                        "string" != typeof r || d.test(r) || (a = r = r.toLowerCase(),
                        l = e),
        ...
        R.each({
            ...
            R.fn[e] = function(n, r) {
                ...
                i = this.length > 1 && !fe[e] ? R.unique(i) : i,
        ...
        R.fn.extend({
            ...
            html: function(e) {
                ...
                if ("string" != typeof e || xe.test(e) || !R.support.leadingWhitespace && me.test(e) || Se[(ve.exec(e) || ["", ""])[1].toLowerCase()])
                ...
                if (this[0]) {
                    ...
                    o = 1 === a.childNodes.length ? a = a.firstChild : a.firstChild) {
                        ...
                        for (var u = 0, f = this.length, p = f - 1; u < f; u++)
                            r.call(n ? d(this[u]) : this[u], i.cacheable || f > 1 && u < p ? R.clone(a, !0, !0) : a)
                    }
                    c.length && R.each(c, v)
                }
                return this
        ...
        var je, Ne, Ae, De = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, Le = /([A-Z]|^ms)/g, Fe = /^-?\d+(?:px)?$/i, Re = /^-?\d/, Me = /^([\-+])=([\-+.\de]+)/, qe = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        ...
        R.each(["height", "width"], function(e, t) {
            R.cssHooks[t] = {
                get: function(e, n, r) {
                    var i;
                    if (n)
                        return 0 !== e.offsetWidth ? y(e, t, r) : (R.swap(e, qe, function() {
                            i = y(e, t, r)
                        }),
                        i)
                },
        ...
        R.extend({
            ...
            ajax: function(e, n) {
                function r(e, n, r, a) {
                    if (2 !== w) {
                        ...
                        if (e >= 200 && e < 300 || 304 === e)
                            if (f.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (R.lastModified[i] = b),
                ...
                e = t),
                n = n || {};
                var i, o, a, s, l, c, u, d, f = R.ajaxSetup({}, n), p = f.context || f, h = p !== f && (p.nodeType || p instanceof R) ? R(p) : R.event, m = R.Deferred(), g = R.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, w = 0, T = {
                    readyState: 0,
                ...
                f.dataTypes = R.trim(f.dataType || "*").toLowerCase().split(et),
                ...
                f.data && f.processData && "string" != typeof f.data && (f.data = R.param(f.data, f.traditional)),
                x(it, f, n, T),
                2 === w)
                    return !1;
                if (u = f.global,
        ...
        R.fn.extend({
            ...
            animate: function(e, t, n, r) {
                function i() {
                    ...
                    var t, n, r, i, a, s, l, c, u, d = R.extend({}, o), f = 1 === this.nodeType, p = f && R(this).is(":hidden");
                    ...
                    for (r in e) {
                        ...
                        delete e[r]),
                        n = e[t],
                        R.isArray(n) ? (d.animatedProperties[t] = n[1],
        ...
        R.offset = {
            ...
            setOffset: function(e, t, n) {
                ...
                var i, o, a = R(e), s = a.offset(), l = R.css(e, "top"), c = R.css(e, "left"), u = {}, d = {};
                ("absolute" === r || "fixed" === r) && R.inArray("auto", [l, c]) > -1 ? (i = (d = a.position()).top,
                o = d.left) : (i = parseFloat(l) || 0,
                o = parseFloat(c) || 0),
    ...
    var b = e("./log")
      ...
      , R = function(e) {
        if ("string" == typeof e) {
            ...
            if (2 === t.length) {
                var n = t[1];
                if ("en" === n || "fr" === n || "es" === n || "pt" === n || "vi" === n || "de" === n || "ru" === n || "id" === n || "ar" === n || "it" === n || "nl" === n || "th" == n)
                    return " "
            }
        }
        return ""
...
define("newweb/common/utils", [], function(e) {
    ...
    return {
        ...
        addToFav: function() {
            t.browser.msie ? window.external.addFavorite("https://fanyi.youdao.com/?keyfrom=favorite", "有道翻译 - 免费在线翻译") : alert("请使用Ctrl + D 手动加入收藏")
        },
        ...
        throttle: function(e, t, n, r) {
            ...
            function o() {
                ...
                s || (r && !a && o(),
                i(),
                void 0 === r && u > e ? o() : !0 !== t && (a = setTimeout(r ? function() {
                    a = void 0
                }
                : o, void 0 === r ? e - u : e)))
            }
